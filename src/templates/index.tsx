  ...
  return (
    <IndexLayout css={HomePosts}>
      <Helmet>
        ...
        {config.strava && <meta property="article:publisher" content={config.strava} />}
        ...
        {config.telegram && (
          <meta
            name="twitter:site"
            content={`@${config.telegram.split('https://twitter.com/')[1]}`}
          />
        )}
...
export const pageQuery = graphql`
  query blogPageQuery($skip: Int!, $limit: Int!) {
    logo: file(relativePath: { eq: "img/logo-bicycle.png" }) {
      childImageSharp {
        gatsbyImageData(layout: FIXED)
      }
    }
    header: file(relativePath: { eq: "img/bg.jpg" }) {
      childImageSharp {
